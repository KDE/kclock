...
Rectangle {
    ...
    implicitWidth: verticalTitleRow.implicitWidth
    implicitHeight: verticalTitleRow.implicitHeight
...
//                                        : (Kirigami.Settings.isMobile ? Kirigami.Units.iconSizes.large : Kirigami.Units.iconSizes.medium)
//                Layout.preferredWidth: Layout.preferredHeight

//                Layout.alignment: Qt.AlignCenter
//            }
//            Kirigami.Heading {
//                level: swipeNavigatorRoot.big ? 4 : 8
//                text: modelData.title
//                color: contentColor
//                Layout.fillWidth: true
//                Layout.alignment: Qt.AlignCenter
